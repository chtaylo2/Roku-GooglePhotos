...
Sub setRelinkText()
    ...
    m.itemLabelMain.text = m.itemLabelMain.text + chr(10) + "Our channel has migrated to the new Google Photos API which will require you to re-authorize your account access."
